                                            ...
                                            TokenImpersonationLevel impersonationLevel)
        {
            if (policy != null)
            {
                if (!AuthenticationManager.OSSupportsExtendedProtection)
                {
                    ...
                    {
                        throw new PlatformNotSupportedException(SR.security_ExtendedProtection_NoOSSupport);
                    }
                }
                else
                {
                    ...
                    if (policy.CustomChannelBinding == null && policy.CustomServiceNames == null)
                        throw new ArgumentException(SR.Format(SR.net_auth_must_specify_extended_protection_scheme, "policy"));
                }
