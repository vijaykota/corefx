...
namespace System.Net
{
    internal class StreamFramer
    {
        ...
        public StreamAsyncHelper TransportAPM
        {
            get
            {
                return m_TransportAPM;
            }
        }
        ...
        public IAsyncResult BeginReadMessage(AsyncCallback asyncCallback, object stateObject)
        {
            ...
            IAsyncResult result = TransportAPM.BeginRead(m_ReadHeaderBuffer, 0, m_ReadHeaderBuffer.Length,
        ...
        private void ReadFrameComplete(IAsyncResult transportResult)
        {
            do
            {
                ...
                int bytesRead = TransportAPM.EndRead(transportResult);
                ...
                transportResult = TransportAPM.BeginRead(workerResult.Buffer, workerResult.Offset, workerResult.End - workerResult.Offset,
                                            m_ReadFrameCallback, workerResult);
        ...
        public IAsyncResult BeginWriteMessage(byte[] message, AsyncCallback asyncCallback, object stateObject)
        {
            ...
            // Charge the first
            IAsyncResult result = TransportAPM.BeginWrite(m_WriteHeaderBuffer, 0, m_WriteHeaderBuffer.Length,
        ...
        private void BeginWriteComplete(IAsyncResult transportResult)
        {
            do
            {
                ...
                TransportAPM.EndWrite(transportResult);
                ...
                transportResult = TransportAPM.BeginWrite(workerResult.Buffer, 0, workerResult.End,
                                            m_BeginWriteCallback, workerResult);
            }
            while (transportResult.CompletedSynchronously);
        }
        ...
        public void EndWriteMessage(IAsyncResult asyncResult)
        {
            ...
            {
                TransportAPM.EndWrite(asyncResult);
            }
        }
    }
